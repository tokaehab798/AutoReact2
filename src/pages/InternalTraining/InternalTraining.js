                        ...
                        <div key={index} className="col-md-4 mb-3 d-flex justify-content-center">
                            <div className="card shadow" style={{ width: '20rem' }}>
                                <div style={{ height: '200px', overflow: 'hidden' }}>
                                    {/* Access the secure_url property of the trainingPicture object */}
                                    <img src={training.trainingPicture.secure_url} className="card-img-top" alt="Training" style={{ objectFit: 'cover', height: '100%' }} onError={imageLoadingFailedHandler} />
                                </div>
