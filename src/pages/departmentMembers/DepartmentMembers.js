...
function DepartmentMembers() {
  ...
  const srcs = ["https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png", "https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png"];
            ...
            <div className="row justify-content-center">
              {srcs.map((src, i) => (
                <div key={i} className="col-md-3 text-center mb-4">
                  ...
                  <Link to={links[i]} className="text-success text-decoration-none">
                    View Profile
                  </Link>
                </div>
              ))}
