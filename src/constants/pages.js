...
const ExternalTraining = lazy(() => import("../pages/externaltraining2/ExternalTraining2"));
const ExternalTraining2 = lazy(() => import("../pages/externaltraining/ExternalTraining"));
