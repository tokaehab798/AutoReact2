...
const DepartmentMembers = lazy(() => import("../pages/departmentMembers/DepartmentMembers"));
const DepartmentMember = lazy(() => import("../pages/departmentMember/DepartmentMember"));
...
const ExternalTraining2 = lazy(() => import("../pages/externaltraining2/ExternalTraining2"));
const ExternalTraining = lazy(() => import("../pages/externaltrainingDetails/ExternalTraining"));
const InternalTraining = lazy(() => import("../pages/InternalTraining/InternalTraining"));
const InternalTraining2 = lazy(() => import("../pages/internaltraining2/InternalTraining2"));
const Studyplan = lazy(() => import("../pages/studyplan/Studyplan"));
const Login = lazy(() => import("../pages/login/Login"));
const AdminAddAbout = lazy(() => import("../pages/adminAddAbout/AdminAddAbout"));
const AdminAddExternal=lazy(() => import ("../pages/adminAddExternal/AdminAddExternal"));
const AdminAddCompetition = lazy(() => import("../pages/adminAddCompetition/AdminAddCompetition"));
const AdminAddStudyplan = lazy(() => import("../pages/adminAddStudyplan/AdminAddStudyplan"));
